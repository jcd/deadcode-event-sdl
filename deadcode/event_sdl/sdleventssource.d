module deadcode.event_sdl.sdleventssource;
...
class SDLEventSource : MainEventSource, ITimer
{
	this()
	{
        super(this);
    ...
    {
        auto msecs = SDL_GetTicks();
        return (cast(double)msecs) / 1000.0;
    }
